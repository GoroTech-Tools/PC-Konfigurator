    ...
    def _get_word_settings(self) -> Dict[str, RegistrySettingInfo]:
        return {
            ...
            "word_correct_sentence_caps": RegistrySettingInfo(
                ...
                value_type="REG_DWORD",
                default_value=0,
                description="Beginnt Sätze automatisch mit Großbuchstaben. Gilt für Word 2013/2016+ und insbesondere auch für Office 2024 LTSC/neuere Builds.",
                impact="Wenn deaktiviert, bleibt die automatische Großschreibung aus. In Office 2024 LTSC kann die UI diese Registry-Option nicht immer zuverlässig spiegeln; der Konfigurator setzt sie zusätzlich per COM.",
                category="Word - Autokorrektur",
                office_versions=["14.0", "15.0", "16.0"],
            ),
            ...
            "word_capitalize_table_cells": RegistrySettingInfo(
                ...
                value_type="REG_DWORD",
                default_value=0,
                description="Beginnt Tabellenzeilen automatisch mit einem Großbuchstaben. Relevant für Word 2013/2016+ sowie neuere Builds, inkl. Office 2024 LTSC.",
                impact="Wenn deaktiviert, korrigiert Word die Großschreibung in Tabellenzellen nicht automatisch. Die Einstellung kann je nach Build/Profil über Registry oder COM gepatcht werden, deshalb gilt hier die LTSC-/Versionen-Logik des Konfigurators.",
                category="Word - Autokorrektur",
                office_versions=["14.0", "15.0", "16.0"],
            ),
            ...
            "word_paste_within_document": RegistrySettingInfo(
                key_path="SOFTWARE\\Microsoft\\Office\\{version}\\Word\\Options",
                value_name="PasteFormattingWithinDocument",
                value_type="REG_DWORD",
                default_value=0,
                description="Einfügen innerhalb desselben Dokuments: ursprüngliche Formatierung beibehalten (Standard).",
                impact="0 verwendet die Formatierung der kopierten Quelle innerhalb desselben Dokuments.",
                category="Word - Einfügen",
                office_versions=["15.0", "16.0"],
            ),
            "word_paste_between_documents": RegistrySettingInfo(
                key_path="SOFTWARE\\Microsoft\\Office\\{version}\\Word\\Options",
                value_name="PasteFormattingBetweenDocuments",
                value_type="REG_DWORD",
                default_value=1,
                description="Einfügen zwischen zwei Dokumenten: Formatierung zusammenführen.",
                impact="1 führt Quell- und Zielformatierung beim Einfügen zwischen Dokumenten zusammen.",
                category="Word - Einfügen",
                office_versions=["15.0", "16.0"],
            ),
            "word_paste_style_conflict": RegistrySettingInfo(
                key_path="SOFTWARE\\Microsoft\\Office\\{version}\\Word\\Options",
                value_name="PasteFormattingTwoDocumentsNoStyles",
                value_type="REG_DWORD",
                default_value=3,
                description="Bei abweichenden Formatvorlagendefinitionen: Formatvorlagen des Ziels verwenden (Standard).",
                impact="3 verwendet die Zielformatvorlagen, wenn die Formatvorlagendefinitionen nicht übereinstimmen.",
                category="Word - Einfügen",
                office_versions=["15.0", "16.0"],
            ),
            "word_paste_other_app": RegistrySettingInfo(
                ...
                value_type="REG_DWORD",
                default_value=2,
                description="Einfügen aus anderen Programmen: Nur den Text übernehmen.",
                impact="2 verwirft die Quellformatierung beim Einfügen aus anderen Anwendungen.",
                category="Word - Einfügen",
                office_versions=["15.0", "16.0"],
            ),
    ...
    def _get_general_office_settings(self) -> Dict[str, RegistrySettingInfo]:
        return {
            ...
            "windows_explorer_show_recent_files": RegistrySettingInfo(
                ...
                value_type="REG_DWORD",
                default_value=0,
                description="Zuletzt verwendete Dateien im Datei-Explorer anzeigen.",
                impact="0 blendet die zuletzt verwendeten Dateien in Schnellzugriff/Explorer aus.",
                category="Windows - Explorer",
                office_versions=["15.0", "16.0"],
            ),
            "windows_startmenu_list_view": RegistrySettingInfo(
                ...
                value_type="REG_DWORD",
                default_value=1,
                description="Anwendungen im Startmenü standardmäßig als Liste darstellen (sofern vom Build unterstützt).",
            ...
            "windows_startmenu_track_documents": RegistrySettingInfo(
                ...
                value_type="REG_DWORD",
                default_value=0,
                description="Empfohlene Dateien, zuletzt verwendete Dateien und Sprunglisten-Einträge im Startmenü nachverfolgen.",
                impact="0 deaktiviert Empfehlungen, zuletzt verwendete Dateien und Sprunglisten-Einträge im Startbereich.",
                category="Windows - Startmenü",
                office_versions=["15.0", "16.0"],
            ),
