...
- Build-Verzeichnis: dist/PC-Konfigurator-v3.3.71/
- EXE: dist/PC-Konfigurator-v3.3.71/PC-Konfigurator.exe
- Release-ZIP: release/PC-Konfigurator-v3.3.71.zip

## Enthaltene Commits (aktuelle Historie)

- `d127970` release: v3.3.70
...
- Build-Datum: 2026-09-16 19:12:28
