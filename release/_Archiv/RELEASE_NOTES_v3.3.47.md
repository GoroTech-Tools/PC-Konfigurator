...
- Build-Verzeichnis: dist/PC-Konfigurator-v3.3.47/
- EXE: dist/PC-Konfigurator-v3.3.47/PC-Konfigurator.exe
- Release-ZIP: release/PC-Konfigurator-v3.3.47.zip

## Enthaltene Commits (aktuelle Historie)

- `5288fd7` feat: separate Outlook font size with 12pt default
- `ec7c309` fix: Word- und Outlook-Designs direkt übernehmen
...
- Build-Datum: 2026-09-10 19:13:25
