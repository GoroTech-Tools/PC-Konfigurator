...
- Build-Verzeichnis: dist/PC-Konfigurator-v3.3.33/
- EXE: dist/PC-Konfigurator-v3.3.33/PC-Konfigurator.exe
- Release-ZIP: release/PC-Konfigurator-v3.3.33.zip

## Enthaltene Commits (aktuelle Historie)

- `f733ac9` release: v3.3.32 Python-PC-Konfigurator
...
- Build-Datum: 2026-09-06 16:30:41
