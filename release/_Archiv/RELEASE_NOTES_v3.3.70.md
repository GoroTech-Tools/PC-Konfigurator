...
- Build-Verzeichnis: dist/PC-Konfigurator-v3.3.70/
- EXE: dist/PC-Konfigurator-v3.3.70/PC-Konfigurator.exe
- Release-ZIP: release/PC-Konfigurator-v3.3.70.zip

## Enthaltene Commits (aktuelle Historie)

- `214a4e8` refactor: move project tools into src
- `8c9e840` ci: update actions to Node 24
- `c9f7ace` release: v3.3.69
- `7185511` Merge pull request #6 from GoroTech-Tools/copilot/fix-windows-explorer-restart-button
- `fe7bb01` Explorer-Neustart berücksichtigt Taskleisten-Ausrichtung

## Technische Build-Informationen

- Build-Datum: 2026-09-15 18:45:06
