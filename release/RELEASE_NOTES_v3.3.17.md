...
- Build-Verzeichnis: dist/PC-Konfigurator-v3.3.17/
- EXE: dist/PC-Konfigurator-v3.3.17/PC-Konfigurator.exe
- Release-ZIP: release/PC-Konfigurator-v3.3.17.zip

## Enthaltene Commits (aktuelle Historie)

- `ba55370` Release v3.3.17: Office-Konfiguration beschleunigen
...
- Build-Datum: 2026-06-19 19:38:57
