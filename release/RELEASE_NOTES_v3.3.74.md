...
- Build-Verzeichnis: dist/PC-Konfigurator-v3.3.74/
- EXE: dist/PC-Konfigurator-v3.3.74/PC-Konfigurator.exe
- Release-ZIP: release/PC-Konfigurator-v3.3.74.zip

## Enthaltene Commits (aktuelle Historie)

- `ff24167` release-v3.3.73
...
- Build-Datum: 2026-09-16 19:52:22
